...
@BeforeAll
    ...
    review = ReviewFactory.createReview(4,"Design can be better",LocalDate.now(),user,product);
}
    ...
    void delete() {
        ...
        ResponseEntity<Review> readResponse = restTemplate.getForEntity(BASE_URL + "/read/" + review.getReviewId(), Review.class);
